---
title: 1-3 Establish SSH Connection
sidebar_position: 3
---

# 1-3 Establishing a SSH Connection

**SSH (Secure Shell)** is a way to control a computer remotely. It lets you run commands and manage files from another device. The connection is encrypted for security. It’s like a safe remote control for computers.
